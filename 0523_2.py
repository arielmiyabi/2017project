...
dir_train="/data2/chenwu/Sketch-recognition-using-deep-learning/data/train"

dir_val="/data2/chenwu/Sketch-recognition-using-deep-learning/data/validation"
...
history=model.fit(fin_train_data,train_label, batch_size=50,nb_epoch=1000)
